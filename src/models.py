...
class BaseModel(nn.Module):
    ...
    def load(self):
        if os.path.exists(self.gen_weights_path):
            ...
            # 检查权重是否使用了DataParallel
            use_dataparallel = any(['module.' in key for key in data['generator'].keys()])
            ...
            print('unable to find generator ...')
        ...
        if os.path.exists(self.dis_weights_path):
            ...
            print('unable to find discriminator ...')
...
class LandmarkDetectorModel(nn.Module):
    ...
    def forward(self, images, masks):
        ...
        # print("image_shape", images_masked.shape)
