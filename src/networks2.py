...
class ForwardAttention(nn.Module):
    def __init__(self, inputChannels, outputChannels, bn=False, sample='down-4', \
        ...
        if sample == 'down-4':
            ...
            self.conv = ForwardAttentionLayer(inputChannels, outputChannels, 7, 1, 3, bias=convBias)
        if bn:
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, residual_blocks=7, init_weights=True):
        ...
        self.ec1 = ForwardAttention(4, 64, sample='')
        self.ec2 = ForwardAttention(64, 128, sample='down-4')
        self.ec3 = ForwardAttention(128, 256, sample='down-4')
